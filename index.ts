...
// ─── Agente disponível (pool compartilhado) ───────────────────────────────────
// Tenta cada canal em sequência. A transação garante que no máximo um canal
// atribui o agente — o segundo já encontra inAttendanceAt != 0 e aborta.
